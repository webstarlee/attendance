              ...
              columns: [
                 {
                  ...
                  responsive: {visible: 'lg'},
                    ...
                    template: function (row, index, datatable) {
                        ...
                        return '\
                        <a href="javascript:;" data-attendance_request_id="'+row.id+'" class="m-attendance-request-edit-btn m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View ">\
                        <i class="la la-edit"></i>\
                        </a>\
                        <a href="javascript:;" data-attendance_request_id="'+row.id+'" class="m-attendance-request-delete-btn m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="View ">\
